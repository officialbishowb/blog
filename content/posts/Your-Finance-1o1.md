...
1. **Salary and spending account** - day-to-day money
2. **Emergency account** - your emergency fund
3. **Asset account** - for investing (ETFs, stocks, etc.)
### Budget Rules
...
This gives you a simple way to split your money across categories. I even built a little [website](https://budget.officialbishowb.com/) I use every month. I probably have too many accounts (some are unnecessary) - one for recurring bills, one for fun, one for online shopping, and one for daily expenses where I drop a set amount each month. You can get a bit carried away with accounts, but whatever works for you.
...
1. They are **cheap** - fees when buying ETFs are generally low
2. They are **diversified**
3. They are **suited for many investors**
4. They are **liquid** - can be bought and sold during market hours
...
1. **Analyze** - Start by listing all your debts. You can sort them by interest rate (high to low) and note each monthly payment.
2. **Utilize lump-sum payments** - Make larger payments when you can. Some banks allow extra payments without penalty, which helps reduce interest paid over time. If you get a bonus at work, consider using it to reduce your debts.
3. **Stay debt free** - Once your debts are paid, try to avoid falling back into debt.
