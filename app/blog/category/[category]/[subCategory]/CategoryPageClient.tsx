    ...
    <div className="min-h-screen pt-20">
      <div className="container section-padding">
        ...
        <h1 className="text-4xl md:text-5xl mb-6">
          Posts with subcategory <span className="text-primary">&quot;{params.subCategory}&quot;</span>
        </h1>
        <p className="text-muted-foreground text-lg mb-12 max-w-2xl">
          Showing {filteredPosts.length} post{filteredPosts.length !== 1 ? "s" : ""} with subcategory &quot;{params.subCategory}&quot; in category &quot;{params.category}&quot;
        </p>
